...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'webrtcchat.data';
    var REMOTE_PACKAGE_BASE = 'webrtcchat.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3677706;
      var PACKAGE_UUID = 'dd52bfc4-8c08-4e0c-b957-633633822764';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 71957, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(71957, 72364, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(72364, 2153388, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2153388, 3650080, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3650080, 3677706, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_webrtcchat.data');

    };
    Module['addRunDependency']('datafile_webrtcchat.data');
